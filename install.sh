...
if ! [ -x "$PREFIX/bin/xray" ]; then
    wget https://github.com/GFW-knocker/Xray-core/releases/download/v1.8.23-mahsa-r1/Xray-android-arm64-v8a.zip
...
fragment_scanner() {
    ...
    lengthOptions=("1-1" "1-2" "1-3" "2-5" "1-5" "1-10" "3-5" "5-10" "3-10" "10-15" "10-30" "10-20" "10-50" "20-50" "50-100" "100-150")
    intervalOptions=("1-1" "1-2" "3-5" "1-5" "4-10" "5-10" "10-15" "10-20" "20-30" "20-50" "40-50" "50-100" "50-80" "100-150" "150-200" "100-200")
